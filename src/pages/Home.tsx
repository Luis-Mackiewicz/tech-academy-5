      ...
      <div className="flex flex-row flex-1 items-center justify-center px-8 gap-16">
        <div className="flex-1 flex flex-col items-center justify-center">
          ...
          <p className="text-white text-lg text-center max-w-md">
            ...
            menos tempo — é sobre foco, organização e fluxo contínuo de
            trabalho. O TaskFlow foi criado para transformar sua rotina com um
            sistema visual de Kanban intuitivo, flexível e eficiente.
          </p>
        </div>
